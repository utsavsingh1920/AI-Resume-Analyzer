...
def run():
    ...
    link = '<b>Built with 🤍 by <a href="https://github.com/utsavsingh1920" style="text-decoration: none; color: #4587f7;">Utsav Singh</a></b>' 
    ...
    if choice == 'User':
        ...
        if act_mail:
            ...
            if not re.match(email_pattern, act_mail):
                ...
                st.stop()
        if act_mob:
            if not re.match(r'^[0-9]{10}$', act_mob):
        ...
        if pdf_file is not None:
            ...
            file_start = pdf_file.read(4)
            if file_start != b'%PDF':
                st.error("❌ This is not a valid PDF file!")
                st.stop()
            pdf_file.seek(0)

            # 4. File size check (2MB limit)
            if pdf_file.size > 200 * 1024 * 1024:
                st.error("❌ File size must be less than 200MB!")
                st.stop()

            st.success("✅ Valid PDF uploaded!")
    ...
    # -------- ORIGINAL CODE CONTINUES --------
            ...
            if resume_data:
                ...
                if 'Objective' in resume_text or 'Summary' in resume_text:
                    resume_score += 6
                    st.markdown('''<h5 style='text-align: left; color: #008000;'>[+] Awesome! You have added Objective/Summary</h5>''', unsafe_allow_html=True)
                else:
                ...
                if 'Education' in resume_text or 'School' in resume_text or 'College' in resume_text:
                    ...
                    resume_score += 12
                    st.markdown('''<h5 style='text-align: left; color: #008000;'>[+] Awesome! You have added Education Details</h5>''', unsafe_allow_html=True)
                else:
                ...
                if 'EXPERIENCE' in resume_text or 'Experience' in resume_text or 'WORK EXPERIENCE' in resume_text or 'Work Experience' in resume_text:
                    resume_score += 16
                    st.markdown('''<h5 style='text-align: left; color: #008000;'>[+] Awesome! You have added Experience</h5>''', unsafe_allow_html=True)
                else:
                    st.markdown('''<h5 style='text-align: left; color: #FF0000;'>[-] Please add Experience. It will help you to stand out from crowd</h5>''', unsafe_allow_html=True)
                if 'INTERNSHIPS' in resume_text or 'INTERNSHIP' in resume_text or 'Internships' in resume_text or 'Internship' in resume_text:
                    resume_score += 6
                    st.markdown('''<h5 style='text-align: left; color: #008000;'>[+] Awesome! You have added Internships</h5>''', unsafe_allow_html=True)
                else:
                    st.markdown('''<h5 style='text-align: left; color: #FF0000;'>[-] Please add Internships. It will help you to stand out from crowd</h5>''', unsafe_allow_html=True)
                if 'SKILLS' in resume_text or 'SKILL' in resume_text or 'Skills' in resume_text or 'Skill' in resume_text:
                    resume_score += 7
                    st.markdown('''<h5 style='text-align: left; color: #008000;'>[+] Awesome! You have added Skills</h5>''', unsafe_allow_html=True)
                else:
                ...
                if 'HOBBIES' in resume_text or 'Hobbies' in resume_text:
                    resume_score += 4
                    st.markdown('''<h5 style='text-align: left; color: #008000;'>[+] Awesome! You have added your Hobbies</h5>''', unsafe_allow_html=True)
                else:
                ...
                if 'INTERESTS' in resume_text or 'Interests' in resume_text:
                    resume_score += 5
                    st.markdown('''<h5 style='text-align: left; color: #008000;'>[+] Awesome! You have added your Interest</h5>''', unsafe_allow_html=True)
                else:
                    st.markdown('''<h5 style='text-align: left; color: #FF0000;'>[-] Please add Interest. It will show your interest other that job.</h5>''', unsafe_allow_html=True)
                if 'ACHIEVEMENTS' in resume_text or 'Achievements' in resume_text:
                    resume_score += 13
                    st.markdown('''<h5 style='text-align: left; color: #008000;'>[+] Awesome! You have added your Achievements </h5>''', unsafe_allow_html=True)
                else:
                ...
                if 'CERTIFICATIONS' in resume_text or 'Certifications' in resume_text or 'Certification' in resume_text:
                    resume_score += 12
                    st.markdown('''<h5 style='text-align: left; color: #008000;'>[+] Awesome! You have added your Certifications </h5>''', unsafe_allow_html=True)
                else:
                ...
                if 'PROJECTS' in resume_text or 'PROJECT' in resume_text or 'Projects' in resume_text or 'Project' in resume_text:
                    resume_score += 19
                    st.markdown('''<h5 style='text-align: left; color: #008000;'>[+] Awesome! You have added your Projects</h5>''', unsafe_allow_html=True)
                else:
                    st.markdown('''<h5 style='text-align: left; color: #FF0000;'>[-] Please add Projects. It will show that you have done work related the required position or not.</h5>''', unsafe_allow_html=True)
    ...
    ###### CODE FOR ABOUT PAGE ######
        ...
        <p align="justify">
            Built with 🤍 by 
            <a href="https://github.com/utsavsingh1920" style="text-decoration: none; color: grey;">Utsav Singh</a> through 
